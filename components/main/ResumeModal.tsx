      ...
      <ModalSection modalshow={aboutShowState.toString()}>
        ...
        <div className='about'>
          <div>
            ...
            <h2>&quot;저는&quot;</h2>
            <h3>&quot;인터랙션 구현을 좋아하는&quot;</h3>
            <p>- 수려한 UI와 아름다운 애니메이션을 만드는 것을 좋아합니다.</p>
            <p>- 사용자에게 새로운 경험을 주는 것이 곧 서비스의 품질의 향상이라고 생각합니다.</p>
            <h3>&quot;직접 만드는 걸 좋아하는&quot;</h3>
            <p>- 바로 라이브러리를 도입하기 보다는 UI와 스스로 만들어보고 원리를 이해하는 것을 즐깁니다.</p>
            <h3>&quot;계속해서 학습해 나가는&quot;</h3>
            <p>- 빠르게 변화하는 프론트엔드 분야에서 적응해나가기 위해 끊임없이 학습합니다.</p>
            <h3>&quot;프론트엔드 개발자 입니다.&quot;</h3>
          </div>
          <div>
            <h2>SKILL SET</h2>
            ...
            <span>
              ...
              처리(Promise, async/await), 클로저, let/const, 디스트럭처링 등을
              활용할 수 있습니다.
              <br />- 웹 브라우저 환경에서 DOM 조작 및 이벤트 처리에 익숙합니다.
            </span>
            <p>TypeScript</p>
            <span>
              - 기본적인 TypeScript 개념에 익숙하며, 변수와 함수 타입 선언, 타입
              가드 사용 등을 할 수 있습니다.
            </span>
            <p>Python</p>
            <span>
            ...
            <span>
              ...
              처리에 대해 이해하고 있으며, 커스텀 훅 패턴을 사용하여 컴포넌트
              재사용이 가능합니다.
            </span>
            <p>Next.js</p>
            <span>
              - SSR(Server Side Rendering) 방식을 이해하고 있으며, next13 버전을
              공부 중입니다.
            </span>
            <p>Django</p>
            <span>
              - DRF(Django REST Framework) 기반의 Django 동작 원리를 이해하고
              있으며, 필요에 따라 DRF 기반 라이브러리를 오버라이드하여 원하는
              기능을 구현할 수 있습니다.
            </span>
            <p>Vue2.js</p>
            <span>
            ...
            <span>
              - useQuery, Mutation, useInfinityQuery 등의 기본적인 API를 활용할
              수 있습니다. Suspense, IntersectionObserver를 함께 활용하여 UI
              구현이 가능합니다.
            </span>
            <h3>Ect</h3>
            <p>Git, Github</p>
...
const ModalSection = styled.section<ModalSectionProps>`
  ...
  > .about {
    ...
    transform: ${(props) =>
      props.modalshow === "true" ? "translate3d(0, 0, 0)" : "translate3d(0, 100px, 0)"};
  ...
  .aboutTitle {
    ...
    transform: ${(props) =>
      props.modalshow === "true" ? "translate3d(0, 0, 0)" : "translate3d(20rem, 0, 0)"};
    opacity: ${(props) => (props.modalshow === "true" ? "1" : "0")};
  }
  ...
  button {
    ...
    transition: 0.3s all;
    transform: ${(props) =>
      props.modalshow === "true" ? "translate3d(0, 0, 0)" : "translate3d(10rem, 0, 0)"};
    opacity: ${(props) => (props.modalshow === "true" ? "1" : "0")};
